...
const PLANS = [
  {
    ...
    features: [
      ...
      "Reativação de inativos (30 dias)",
      "Relatórios de consultas e pacientes",
      "Relatório financeiro (visualização)",
    ],
  },
  {
    name: "Professional",
    ...
    features: [
      ...
      "Reativação escalonada 30, 60 e 90 dias",
      "Relatório de inadimplentes",
      "Exportação CSV / XML / PDF",
      "Pipeline com colunas customizadas",
      "Suporte prioritário",
    ],
  },
];
